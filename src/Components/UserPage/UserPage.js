  ...
  return (
    ...
    {isEditing ? (
      <div className='FormChangeName'>
        ...
        <input className="InputChangeName" value={firstName} onChange={e => setFirstName(e.target.value)}   placeholder={user.firstName}/>
        <input className="InputChangeName" value={lastName} onChange={e => setLastName(e.target.value)}  placeholder={user.lastName} />
        </div>
